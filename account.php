...
<div class="container">
    <div class="well col-sm-6 col-sm-offset-3">
        <form class="form-signin" method="post" action="procedures/changePassword.php">
            ...
            <input type="password" id="inputCurrentPassword" name="current_password" class="form-control"
            ...
            <input type="password" id="inputPassword" name="confirm_password" class="form-control"
